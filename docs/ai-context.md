...
- 设置窗口支持修改快捷键
- 设置窗口支持切换识别窗口定位方式
- 设置窗口采用单页三分区布局，集中管理截图激活、识别结果、翻译与文本编辑设置
...
- 当前已重新验证 `swift test`（47 项）和 `./scripts/codex-run.sh --verify`
...
3. 补充测试与回归用例  
   当前已有 47 项单测；块选择视觉、真实快捷键分发和设置页条件布局仍需人工回归。
