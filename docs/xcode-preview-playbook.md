...
2. 打开专用预览宿主文件：`Sources/TextGrabberKit/UI/ResultPopoverFormalPreviewHost.swift`。
...
2. 回到 `ResultPopoverFormalPreviewHost.swift`。
...
- 正式结果页预览统一在 `ResultPopoverFormalPreviewHost.swift` 完成。
